 ...
 * @author GarandaTech
 */
    @WebServlet(urlPatterns = {"/DebitSoldClientProviderEdit"})
public class DebitSoldClientProviderEdit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                response.sendRedirect("view/editClient.jsp?id="+client.getTraderByIdclient().getIdtrader()+"&succesDebitSold");
            } catch (Exception e) {
