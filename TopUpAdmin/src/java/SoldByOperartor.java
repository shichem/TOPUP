 ...
 * @author GarandaTech
 */
@WebServlet(urlPatterns = {"/SoldByOperartor"})
public class SoldByOperartor extends HttpServlet {
...
//                String[] arrOfStr = name.split("-", 5);
            ...
            for (int i = 0; i < listLable.size(); i++) {
                out.print("{\"label\":\"" + (String) listLable.get(i) + "\",\"data\": " + String.valueOf(list1Count.get(i)) + "}");
