 ...
 * @author GarandaTech
 */
@WebServlet(urlPatterns = {"/AddSoldClientProviderEdit"})
public class AddSoldClientProviderEdit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                response.sendRedirect("view/editClient.jsp?id="+client.getTraderByIdclient().getIdtrader()+"&succesSold");
            } catch (Exception e) {
