                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><%=new Trader_Util().countTraderByCatgory(staticVars.traderCategory_Grossiste)%></div>
                                        <div> <%=staticVars.traderCategory_Grossiste%> </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><%=new Trader_Util().countTraderByCatgory(staticVars.traderCategory_Detaillant)%></div>
                                        <div><%=staticVars.traderCategory_Detaillant%> </div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><%=new Trader_Util().countTraderByType(staticVars.traderType_Application)%></div>
                                        <div> <%=staticVars.traderType_Application%> </div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><%=new Trader_Util().countTraderByType(staticVars.traderType_PuceTOPUP)%></div>
                                        <div> <%=staticVars.traderType_PuceTOPUP%> </div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
